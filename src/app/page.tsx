...
import { FaFileCsv, FaChartBar, FaWallet } from "react-icons/fa";
import { Button } from "@/components/Button";

const subsections = [
	{
		title: "Import Your CSVs",
		text: "Easily upload your bank or budget CSV files. Our tool automatically detects columns and helps you map your data.",
...
export default function Home() {
	return (
		<div className="min-h-screen flex flex-col">
			{/* Top Section */}
			<section className="relative bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-gray-950 p-8 sm:p-16 flex flex-col justify-end h-[220px] sm:h-[260px]">
				<h1 className="text-3xl sm:text-5xl font-bold mb-2 text-gray-900 dark:text-gray-100">
					Welcome to CSV Budget
				</h1>
				<p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl">
					A simple, privacy-friendly way to analyze your finances from CSV files.
				</p>
				<Button className="absolute bottom-6 right-6">Get Started</Button>
			</section>
